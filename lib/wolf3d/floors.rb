...
module Wolf3D
  ...
  class Floors
    ...
    # middle of one — which is what the dial for measuring a later floor's cost makes — holds
    # floors that no menu can start you on, and saying so is better than offering an episode
    # that begins in the wrong place.
    def episodes
